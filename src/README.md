...
New to Fiber-seq in the lab? Start with the [Bench Protocol](protocol/bench-protocol.md) for the complete wet lab workflow from cells to sequencing-ready libraries.

This is also the book for the computational tools of [Fiber-seq](glossary.md#fiber-seq) which describes the two major software tools:
